...
Page({
    ...
    if (justbackindex == 1) { //人像面
      ctx.takePhoto({
        ...
        success: (res) => {
          ...
          wx.uploadFile({
            url: app.globalData.apiUrl + 'appeal/idCardFrontUpload.do',
      ...
      ctx.takePhoto({
        ...
        success: (res) => {
          ...
          wx.uploadFile({
            url: app.globalData.apiUrl + 'appeal/idCardBackUpload.do',
  ...
  startAttestation: function () {
    ...
    if (that.data.next == true) {
      ...
      wx.request({
        url: app.globalData.apiUrl + 'appeal/appealOcrDiscern.do',
        data: {
          openid: that.data.openid
        },
        method: 'POST',
