// pages/revocationPhoto/revocationPhoto.js
const app = getApp();
Page({
    ...
    if (justbackindex == 1) { //人像面
      ctx.takePhoto({
        ...
        success: (res) => {
          ...
          wx.uploadFile({
            url: app.globalData.apiUrl + 'alarm/backoutFrontUpload.do',
      ...
      ctx.takePhoto({
        ...
        success: (res) => {
          ...
          wx.uploadFile({
            url: app.globalData.apiUrl + 'alarm/backoutBackUpload.do',
  ...
  startAttestation: function () {
    ...
    if (that.data.next == true) {
      ...
      wx.request({
        url: app.globalData.apiUrl + 'alarm/backoutOcrDiscern.do',
        data: {
          alarm_people_openid: that.data.openid
        },
        method: 'POST',
        ...
        success: function (res) {
          if (res.data.code == '200') {
            ...
            wx.redirectTo({
              url: '../revocationMyinformation/revocationMyinformation',
            })
