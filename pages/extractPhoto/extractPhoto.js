// pages/extractPhoto/extractPhoto.js
const app = getApp();
Page({
    ...
    if (justbackindex == 1) { //人像面
      ctx.takePhoto({
        ...
        success: (res) => {
          ...
          wx.uploadFile({
            url: app.globalData.apiUrl + 'alarm/extractFrontUpload.do',
      ...
      ctx.takePhoto({
        ...
        success: (res) => {
          ...
          wx.uploadFile({
            url: app.globalData.apiUrl + 'alarm/extractBackUpload.do',
  ...
  startAttestation: function () {
    ...
    if (that.data.next == true) {
      ...
      wx.request({
        url: app.globalData.apiUrl + 'alarm/extractOcrDiscern.do',
        data: {
          alarm_people_openid: that.data.openid
        },
        method: 'POST',
        ...
        success: function (res) {
          if (res.data.code == '200') {
            ...
            that.setData({
              ...
              IDCarddisplay: false,
              verify: {
                alarm_people_photo: app.globalData.extract_people_photo,
            ...
            wx.redirectTo({
              url: '../extractMyinformation/extractMyinformation',
            })
